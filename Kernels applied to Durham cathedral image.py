...
# plt.show()
# fig, ax = plt.subplots(figsize=(edge_detected_image.shape[1]/100, edge_detected_image.shape[0]/100), dpi=100)
# plt.imshow(edge_detected_image)
# plt.axis('off')  # Turn off axis
# plt.show()
# fig, ax = plt.subplots(figsize=(blurred_image.shape[1]/100, blurred_image.shape[0]/100), dpi=100)
