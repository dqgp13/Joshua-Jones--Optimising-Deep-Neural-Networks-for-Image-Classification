...
# fig, ax = plt.subplots(figsize=(ft_product_blue.shape[1]/100, ft_product_blue.shape[0]/100), dpi=100)
# ax.imshow(np.log2(abs(ft_product_blue))/255, cmap='gray')
# ax.axis('off')  # Turn off axis
# plt.show()
# fig, ax = plt.subplots(figsize=(shifted_ft_product_blue.shape[1]/100, shifted_ft_product_blue.shape[0]/100), dpi=100)
# ax.imshow(np.log2(abs(shifted_ft_product_blue))/255, cmap='gray')
# ax.axis('off')  # Turn off axis
# plt.show()
